...
import {
  ...
  itemComment,
  loadingList,
  loadingListReservedCalendarTime,
  menu,
  menuHasPermission,
  menuHasRole,
  permission,
...
export const approvalReportRelations = relations(
  approvalReport,
  ({ one, many }) => ({
    user: one(user, {
...
export const approvalReportHasImageRelations = relations(
  approvalReportHasImage,
  ({ one }) => ({
...
export const loadingListReservedCalendarTimeRelations = relations(
  loadingListReservedCalendarTime,
  ({ one }) => ({
...
export const menuHasPermissionRelations = relations(
  menuHasPermission,
  ({ one }) => ({
...
export const technicalReportRelations = relations(
  technicalReport,
  ({ one, many }) => ({
    user: one(user, {
...
export const technicalReportHasImageRelations = relations(
  technicalReportHasImage,
  ({ one }) => ({
...
export const userHasPermissionRelations = relations(
  userHasPermission,
  ({ one }) => ({
    permission: one(permission, {
