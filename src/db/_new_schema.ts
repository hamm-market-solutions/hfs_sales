...
export const userHasPermissions = mysqlTable(
  ...
  (table) => {
    return {
      userPermissionUnique: t
        .uniqueIndex("user_permission_unique")
        .on(table.user, table.permission),
    };
  },
);
...
export const assortments = mysqlTable(
  ...
  (table) => {
    return {
      assortmentUnique: t
        .uniqueIndex("assortment_unique")
        .on(table.code, table.sizeCode),
    };
  },
);
