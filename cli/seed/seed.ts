...
export async function runner(command: string, commandArgs: { [key: string]: string }) {
    if (command === "up") {
...
//     const result = await runner(subCommand, commandArgs);
